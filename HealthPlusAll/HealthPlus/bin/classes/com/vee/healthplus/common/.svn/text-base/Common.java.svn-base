...
public class Common {
	...
	public static final String APPLICATION_ID = "700071";
	// public static final String UPDATE_SERVER =
	// "http://cdn.17vee.com/lmstation/shoujiweishi/"
	public static final String UPDATE_SERVER = "http://easyplay.17vee.com/EasyPlay/lmstation/healthplus/"
			+ APPLICATION_ID + "/";
